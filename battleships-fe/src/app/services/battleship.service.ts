...
export class BattleshipService {
  ...
  constructor(private readonly signalRService: SignalrService, private readonly boardService: BoardService) {
  ...
  setMockGameSessionData(){
    const data = {
      playerOne: {name: "Marinis",board: this.boardService.createBoard(10, CellType.Empty)} as Player,
      playerTwo: {name: "Stepas", board: this.boardService.createBoard(10, CellType.NotShot)} as Player,
      areShipsPlaced: true
    } as GameData
